...
qr_scanner__WEBPACK_IMPORTED_MODULE_0__["default"].hasCamera().then(function (hasCamera) {
  if (hasCamera) {
...
fileSelector.addEventListener('change', function (event) {
  ...
  qr_scanner__WEBPACK_IMPORTED_MODULE_0__["default"].scanImage(file, {
    returnDetailedScanResult: true
  }).then(function (result) {
    return setResult(fileQrResult, result);
  })["catch"](function (e) {
    return setResult(fileQrResult, {
