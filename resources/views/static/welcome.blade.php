...
<body class="antialiased font-dm">
    <div class="relative flex items-center justify-center min-h-screen py-4 bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center justify-center">
                <svg width="30" height="30" viewBox="0 0 30 30">
                    <circle fill="white" cx="15" cy="15" r="14" stroke="green" stroke-width="2"></circle>
                    <path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke="green" stroke-width="2" d="M 5 0 Q 10 -7 15 0 Q 20 7 25 0 Q 30 -7 35 0 Q 40 7 45 0">
                        <animateTransform attributeName="transform" attributeType="XML" type="translate" from="-20 14" to="0 14" dur="1s" repeatCount="indefinite"></animateTransform>
                    </path>
                </svg>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7"><a href="{{ route('qr-code.index') }}" class="text-gray-900 underline dark:text-white">Create Qr Code</a></div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7"><a href="{{ route('qr-code.scan') }}" class="text-gray-900 underline dark:text-white">Scan Qr Code</a></div>
                        </div>
                    </div>
                </div>
            </div>

            <div class="flex items-center justify-center mt-4 sm:justify-between">
                <div class="text-sm text-center text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        ...
                        <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" class="w-5 h-5 -mt-px text-gray-400" viewBox="0 0 24 24">
