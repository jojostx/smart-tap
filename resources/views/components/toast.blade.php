@props(['hasCloseButton', 'showToast', 'type'])
  ...
  <script>
    document.addEventListener('alpine:init', () => {
      Alpine.data('toast', () => ({
        ...
        // Data [getters] //
        getIcon() {
          return this.toast_types[this.toast_type]['icon'];
        },

        getDialogueClasses() {
          return this.toast_types[this.toast_type]['dialogue_classes'];
        },

        getButtonClasses() {
          return this.toast_types[this.toast_type]['button_classes'];
        },
        ...
        dialogue: {
          ...
          '@open-toast.window'($event) {
            ...
            toast_type = $event.detail.toast_type;

            this.message = message;

            this.toast_type = (toast_type in this.toast_types) ? toast_type : 'default';
