<x-guest-layout>
    <x-slot:title>
        ...
        <aside x-data="{}" x-bind:class="$store.sidebar.isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0 rtl:lg:-translate-x-0 rtl:translate-x-full'" class="fixed inset-y-0 left-0 z-20 flex flex-col h-screen overflow-hidden transition-all translate-x-0 bg-white shadow-2xl rtl:left-auto rtl:right-0 filament-sidebar lg:border-r w-80 lg:z-0 lg:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
            <header class="border-b h-[4rem] shrink-0 px-6 flex items-center filament-sidebar-header dark:border-gray-700">
                <a href="/">
                    <svg role="img" aria-label="Filament" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 303 61" class="w-24 h-6 fill-current">
            ...
            <nav class="flex-1 py-6 overflow-y-auto filament-sidebar-nav">
                ...
                <ul class="px-6 space-y-6">
                    <li x-data="{ label: '' }" class="filament-sidebar-group">

                        <ul x-collapse.duration.200ms="" class="-mx-3 space-y-1 text-sm">
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium text-white transition rounded-lg bg-primary-500">
                    ...
                    <li>
                        <div class="-mr-6 border-t dark:border-gray-700"></div>
                    </li>
                    <li x-data="{ label: 'Shop' }" class="filament-sidebar-group">
                        <button x-on:click.prevent="$store.sidebar.toggleCollapsedGroup(label)" class="flex items-center justify-between w-full">
                            <p class="text-xs font-bold tracking-wider text-gray-600 uppercase dark:text-gray-300">
                                Shop
                            </p>

                            <svg x-show="$store.sidebar.groupIsCollapsed(label)" class="w-3 h-3 text-gray-600 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" style="display: none;">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path>
                            </svg>
                            <svg x-show="! $store.sidebar.groupIsCollapsed(label)" class="w-3 h-3 text-gray-600 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 15l7-7 7 7"></path>
                            </svg>
                        </button>

                        <ul x-show="! $store.sidebar.groupIsCollapsed(label)" x-collapse.duration.200ms="" class="mt-2 -mx-3 space-y-1 text-sm">
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/products" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/customers" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/orders" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/categories" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/brands" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/discounts" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/reviews" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                    ...
                    <li x-data="{ label: 'Blog' }" class="filament-sidebar-group">
                        <button x-on:click.prevent="$store.sidebar.toggleCollapsedGroup(label)" class="flex items-center justify-between w-full">
                            <p class="text-xs font-bold tracking-wider text-gray-600 uppercase dark:text-gray-300">
                                Blog
                            </p>
                        ...
                        <ul x-show="! $store.sidebar.groupIsCollapsed(label)" x-collapse.duration.200ms="" class="mt-2 -mx-3 space-y-1 text-sm" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/blog/posts" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/blog/categories" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/blog/authors" x-on:click="window.matchMedia(`(max-width: 1024px)`).matches && $store.sidebar.close()" class="flex items-center gap-3 px-3 py-2 font-medium transition rounded-lg hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
